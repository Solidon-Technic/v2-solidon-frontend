...
const NavTabs = ({ categories }: { categories: Category[] }) => {
  return (
    <div className="nav-tabs bg-space_indigo-600 border-t border-white/10">
      <div className="content-container">
        <div className="flex items-center gap-1 h-10 overflow-x-auto no-scrollbar">
          ...
          <LocalizedClientLink
            href="/oferte"
            className="px-3 py-1.5 text-white/80 hover:text-white hover:bg-white/10 rounded text-sm whitespace-nowrap transition-colors"
          >
            Oferte
          </LocalizedClientLink>
