...
const BenefitIcons = {
  truck: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12" aria-hidden>
...
const Hero = () => {
  ...
  return (
    ...
    <div className="relative h-[350px] small:h-[400px] rounded-lg overflow-hidden group flex-shrink-0">
      ...
      {/* Benefits Section */}
      <div className="bg-white rounded-lg border border-neutral-200 p-3 small:p-4 flex-1">
        <div className="grid grid-cols-2 small:grid-cols-4 gap-3 small:gap-4 h-full">
