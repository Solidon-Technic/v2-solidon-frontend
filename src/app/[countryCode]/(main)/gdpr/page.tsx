...
export const metadata: Metadata = {
  title: "GDPR - Protecția datelor cu caracter personal - Solidon",
  description:
  ...
  return (
    <div className="content-container py-8 small:py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl-semi text-ui-fg-base mb-4">
          Prelucrarea datelor cu caracter personal
        </h1>
        <p className="text-lg font-semibold text-ui-fg-subtle mb-10">GDPR</p>
        ...
        <div className="text-ui-fg-subtle space-y-10 text-base leading-7">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-3 mt-5 text-base">
              <li><strong>Date personale</strong> sau <strong>Datele cu caracter personal</strong> se referă la orice informație care face posibilă identificarea unei persoane fizice (persoană vizată).</li>
              <li><strong>Persoana vizată</strong> – reprezintă o persoană fizică identificată sau identificabilă. O persoană fizică „identificabilă” este o persoană care poate fi identificată, direct sau indirect, inclusiv prin referire la un număr de identificare sau la unul sau mai mulți factori caracteristici identității sale fizice, fiziologice, mentale, economice, culturale sau sociale.</li>
              <li><strong>Prelucrarea</strong> – reprezintă a efectua orice operațiune sau set de operațiuni asupra Datelor cu caracter personal, cu sau fără mijloace automate, precum colectarea, înregistrarea, organizarea, stocarea, adaptarea sau modificarea, recuperarea, consultarea, utilizarea, dezvăluirea (prin transmitere, difuzare sau punere la dispoziție în alt mod), alinierea sau combinarea, blocarea, ștergerea sau distrugerea.</li>
              <li><strong>Restricția prelucrării</strong> – se referă la marcarea datelor personale prelucrate cu scopul de a limita prelucrarea lor în viitor.</li>
              <li><strong>Crearea de profiluri</strong> – se referă la orice formă autorizată de prelucrare a datelor personale consistând în folosirea datelor personale pentru a evalua anumite aspecte personale caracteristice pentru o persoană fizică, în particular pentru a analiza sau a prezice aspecte referitoare la performanța la muncă, situația economică, sănătatea, preferințele personale, interesele, fiabilitatea, locația sau deplasările unei persoane fizice.</li>
              <li><strong>Pseudonimizarea</strong> – este prelucrarea datelor personale într-o asemenea manieră încât datele personale nu mai pot fi atribuite unei persoane vizate fără utilizarea unor informații adiționale, cu condiția ca aceste informații adiționale să fie stocate separat și să fie supuse unor măsuri tehnice și organizaționale care să asigure faptul că datele personale nu sunt atribuite unei persoane fizice identificate sau identificabile.</li>
              <li><strong>Operator</strong> sau <strong>operator responsabil pentru prelucrare</strong> – este persoana fizică sau juridică, autoritate publică, agenție sau alt organ care, singur sau cu ajutorul unor terțe părți, determină scopurile sau mijloacele prelucrării de date personale; acolo unde scopurile și mijloacele prelucrării sunt determinate de legislația Uniunii sau a Statelor Membre, operatorul sau criteriile specifice pentru nominalizarea lui pot fi furnizate de legislația Uniunii sau a Statelor Membre.</li>
              <li><strong>Destinatarul</strong> – este o persoană fizică sau juridică, autoritate publică, agenție sau alt organ, către care datele personale sunt dezvăluite, fie el o terță parte sau nu. Cu toate acestea, autoritățile publice care ar putea să primească datele personale în cadrul unei anchete particulare în concordanță cu legislația Uniunii sau a Statelor Membre nu vor fi văzute ca destinatari; prelucrarea acelor date de către autoritățile publice va fi în conformitate cu regulile aplicabile protecției datelor în concordanță cu scopurile prelucrării.</li>
              <li><strong>Terță parte</strong> – este o persoană fizică sau juridică, autoritate publică, agenție sau alt organ în afara persoanei vizate, operator, prelucrător și persoane care, sub autoritatea directă a operatorului sau a prelucrătorului, sunt autorizate să prelucreze date personale.</li>
              <li><strong>Consimțământ</strong> – consimțământul persoanei vizate este orice indicație dată în mod liber, specifică, informată și clară pe care persoana vizată o oferă printr-o declarație sau printr-o acțiune afirmativă clară, semnificând acordul pentru prelucrarea datelor sale personale.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-ui-fg-base mb-4">2. Numele și adresa reprezentantului website-ului ACCESORII-TERMOPANE.RO</h2>
            <p className="font-semibold">SOLIDON TEHNIC SRL</p>
            <p className="mt-3">Adresa: Strada Sadului 35, Sector 5, București, 052167, România</p>
            <p>C.U.I.: RO32867737</p>
            <p>Nr. Ord. Reg. Com: J40/2542/2014</p>
            <p>Email: comenzi@accesorii-termopane.ro</p>
            <p>Mobil: 0728 137 137</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-ui-fg-base mb-4">3. Întrebări, sugestii</h2>
            <p>
              Orice persoană vizată ne poate oricând contacta în mod direct cu orice întrebări sau sugestii în legătură cu protecția datelor cu caracter personal la următoarea adresă de e-mail:{" "}
              <a href="mailto:comenzi@accesorii-termopane.ro" className="text-space_indigo hover:underline text-base">
          ...
          <section>
            <h2 className="text-lg font-semibold text-ui-fg-base mb-4">11. Perioada pentru care vor fi stocate datele cu caracter personal</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ui-fg-base mb-4">12. Furnizarea de date cu caracter personal ca cerință legală sau contractuală</h2>
            <p>
